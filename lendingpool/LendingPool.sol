...
contract LendingPool is ReentrancyGuard, VersionedInitializable {
    ...
    **/
        ...
        onlyAmountGreaterThanZero(_amount)
    {
        ...
        //calculating fees
        vars.borrowFee = feeProvider.calculateLoanOriginationFee(_reserve, _amount);
    ...
    **/
        ...
        onlyAmountGreaterThanZero(_amount)
    {
        ...
        uint interestFee = vars.borrowBalanceIncrease.div(5);

        vars.originationFee = core.getUserOriginationFee(_reserve, _onBehalfOf);
        vars.originationFee = vars.originationFee.add(interestFee); //Fee = fee + spread
        vars.compoundedBorrowBalance = vars.compoundedBorrowBalance.sub(interestFee);
    ...
    * this is regulated by Circulate to ensure that the protocol is not abused, and the user is paying a fair
